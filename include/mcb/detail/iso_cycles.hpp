#ifndef MCB_DETAIL_ISO_CYCLES_HPP_
#define MCB_DETAIL_ISO_CYCLES_HPP_
...
namespace mcb {
    ...
    namespace detail {
        ...
        void build_iso_cycles(const Graph &g, const WeightMap &weight_map,
            ...
            graph_t cycles_g;
            typename boost::property_map<graph_t, boost::tree_t>::type tree_map = boost::get(boost::tree_t(), cycles_g);
            typename boost::property_map<graph_t, boost::edge_t>::type edge_map = boost::get(boost::edge_t(), cycles_g);
            typename boost::property_map<graph_t, boost::bad_t>::type bad_map = boost::get(boost::bad_t(), cycles_g);
